<div class="container">
	<!-- Jumbotron Header -->
	<header class="jumbotron my-5" style="background: url(<?= base_url('assets/img/img2.jpg'); ?>) center; height:70vh;">
		...
		<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa, ipsam, eligendi, in quo sunt
			possimus non incidunt odit vero aliquid similique quaerat nam nobis illo aspernatur vitae fugiat numquam repellat.</p>
	</header>
			...
			<div class="row text-center">
				<div class="col-sm-4">
					<div class="team-member">
						<img class="mx-auto rounded-circle" height="245" width="260" src="https://www.jquery-az.com/html/images/banana.jpg"
						 alt="">
						<p>
							<h4>Kay Garland</h4>
